...
insert into ts_domains(ts_id, ts_name, ts_ip_address, ts_port, ts_db_versions, ts_tran_importance_id, ts_user_importance_id, version_info, ts_dynamic_group_reassign) values (1, 'Local Domain', 0, 80, '10.5.0.0', 5, 5, 1, false);
...
insert into ts_introscope_ems(version_info, ts_name, ts_description, ts_username, ts_password, ts_hostname, ts_em_version, ts_web_view_version, ts_web_start_version, ts_port, ts_web_view_port, ts_web_start_port, ts_has_web_view, ts_has_web_start, ts_tran_trace_duration, ts_tran_trace_threshold_percnt, ts_enabled, ts_soft_delete)
 values (1, '', '', '','','localhost', '10.5.0.0', '', '',5001, 8080, 8081, false, false, 30, 50, false, false);
...
-- initialize global btstats settings
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1057, 1, 'btstats.enabled', 'true', 'enable/disable btstats collection', 'true',false);
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1058, 1, 'btstats.urlpathenabled', 'false', 'enable/disable url path matching and collection for btstats', 'false', false);
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1059, 1, 'btstats.usergroupenabled', 'false', 'enable/disable user group matching and collection for btstats', 'false', false);
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1060, 1, 'btstats.maxstatspertim', '600', 'max number of btstats possible per interval per tim', '600', false);

--initialize geolocation group settings
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1061, 1, 'btstats.geolocationprocessing', 'false', 'enable/disable Geo Location processing', 'false',false);
insert into ts_settings (ts_id, version_info, ts_key, ts_value, ts_description, ts_default, ts_soft_delete) values(1062, 1, 'btstats.geolocationgranularity', '2', 'Select Geo Location granularity', '2',false);
...
INSERT INTO appmap_vertices (vertex_id, start_time, end_time, fork, business_service)
    SELECT 0, TIMESTAMP '1979-1-1 0:0:0', TIMESTAMP '1979-1-1 0:0:0', 0, 'CA_APM_INTERNAL' WHERE NOT EXISTS(SELECT 1 FROM appmap_vertices WHERE vertex_id = 0);    
