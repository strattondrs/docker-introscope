...
docker run -d --name introscope-em -e HEAP="2048m" -p 5001:5001 -p 8081:8081 -v /Users/grogu01/git/docker-introscope/transfer/xmltv:/transfer/xmltv --link introscope-db:db ggrossbe/introscope-em-9.7
